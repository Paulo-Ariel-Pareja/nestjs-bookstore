...
export class rolesRelationship1608086259485 implements MigrationInterface {
    name = 'rolesRelationship1608086259485'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_detail" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, "lastname" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_673613c95633d9058a44041794d" PRIMARY KEY ("id"))`);
